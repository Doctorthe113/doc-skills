...
3. Keep the PRD easy to read. Write in ASD-STE100 Simplified Technical English, as the parent skill requires. Use short sections, concrete examples, labeled code fences, and familiar words. Write each requirement and acceptance criterion as one observable statement. Define unavoidable technical terms and acronyms when first used, and replace jargon with a plain explanation.
